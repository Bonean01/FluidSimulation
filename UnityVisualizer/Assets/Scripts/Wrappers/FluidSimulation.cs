...
public class FluidSimulation : IDisposable {
    ...
    [DllImport("FluidSolver")] private extern static void SetCell(IntPtr handle, int i, int j, CellConfig cellProperties);
    ...
    public void SetCell(int i, int j, CellConfig cellProperties) => SetCell(m_handle, i, j, cellProperties);
}
